...
class OrderFacadeIntegrationTest extends IntegrationTest {
    ...
    void payment_ShouldRollback_WhenPaymentFailed() {
        ...
        BusinessException exception = assertThrows(BusinessException.class, () -> {
            orderFacade.payment(orderId, userCoupon.getUserCouponId(), true);
        });
        ...
        Assertions.assertEquals(afterOrder.getStatus(), OrderStatus.FAILED);
        ...
        Assertions.assertEquals(userCouponOptional.get().getStatus(), UserCouponStatus.ISSUED);
    }
    ...
    void payment_ShouldSucceed_WhenPaymentSuccessful() {
        ...
        // when
        orderFacade.payment(orderId, userCoupon.getUserCouponId(), false);
