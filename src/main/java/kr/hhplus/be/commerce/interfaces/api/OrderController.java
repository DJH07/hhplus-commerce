...
public class OrderController {
    ...
    public ResponseEntity<ResponseDto> processPayment(@PathVariable Long orderId, @PathVariable Long userCouponId) {

        PaymentStatus response = orderFacade.payment(orderId, userCouponId, false);
