...
public enum BusinessErrorCode implements ErrorCodeEnum {
    ...
    COUPON_QUANTITY_NOT_FOUND(HttpStatus.NOT_FOUND, "해당 쿠폰의 개수를 찾을 수 없습니다."),
    USER_COUPON_NOT_FOUND(HttpStatus.NOT_FOUND, "해당 ID의 사용자 보유 쿠폰을 찾을 수 없습니다."),
    PRODCUT_NOT_FOUND(HttpStatus.NOT_FOUND, "해당 ID의 상품 정보를 찾을 수 없습니다."),
    PRODCUT_STOCK_NOT_FOUND(HttpStatus.NOT_FOUND, "해당 ID의 상품 개수 정보를 찾을 수 없습니다."),
    ORDER_NOT_FOUND(HttpStatus.NOT_FOUND, "해당 ID의 주문 정보를 찾을 수 없습니다."),
